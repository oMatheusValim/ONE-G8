...
## 🔎 Sobre 
Este repositório foi criado para compartilhar os desafios de programação e projetos que estou desenvolvendo ao longo da minha jornada no programa de [Iniciante em Programação G8 - ONE](https://cursos.alura.com.br/program/certificate/PRODUCT_PROGRAM/14), criado em uma parceria entre a Alura e a Oracle Next Education.
...
- [Praticando Python para Data Science: Challenge Alura Store](https://cursos.alura.com.br/user/matheus-valim1007/course/praticando-python-data-science-challenge-alura-store/certificate)
- [Modelagem de dados: identificando entidades, atributos, relacionamentos](https://cursos.alura.com.br/user/matheus-valim1007/course/modelagem-dados-entidades-atributos-relacionamentos/certificate)
- [Modelagem de dados: desenvolvendo o modelo lógico](https://cursos.alura.com.br/user/matheus-valim1007/course/modelagem-dados-desenvolvendo-modelo-logico/certificate)
- [Modelagem de dados: construindo o modelo físico](https://cursos.alura.com.br/user/matheus-valim1007/course/modelagem-dados-construindo-modelo-fisico/certificate)

### Aprendendo a fazer ETL
- [NumPy: análise numérica eficiente com Python](https://cursos.alura.com.br/user/matheus-valim1007/course/numpy-analise-numerica-eficiente-pythons/certificate)
- [Pandas: conhecendo a biblioteca](https://cursos.alura.com.br/user/matheus-valim1007/course/pandas-conhecendo-biblioteca/certificate)
- [Pandas I/O: trabalhando com diferentes formatos de arquivos](https://cursos.alura.com.br/user/matheus-valim1007/course/pandas-io-trabalhando-diferentes-formatos-arquivos/certificate)
- [Pandas: transformação e manipulação de dados](https://cursos.alura.com.br/user/matheus-valim1007/course/pandas-transformacao-manipulacao-dados/certificate)
- [Data Visualization: criando gráficos com bibliotecas Python](https://cursos.alura.com.br/user/matheus-valim1007/course/data-visualization-graficos-bibliotecas-python/certificate)
- [Challenge Telecom X: análise de evasão de clientes](https://cursos.alura.com.br/user/matheus-valim1007/course/challenge-telecom-x-analise-evasao-clientes/certificate)
- [IA aplicada a Data Science: utilizando IA na construção de visualização de dados](https://cursos.alura.com.br/user/matheus-valim1007/course/ia-aplicada-data-science-ia-construcao-visualizacao-dados/certificate)

### Estatística e Machine Learning
- [Estatística com Python: resumindo e analisando dados](https://cursos.alura.com.br/user/matheus-valim1007/course/estatistica-python-resumindo-analisando-dados/certificate)
- [Estatística com Python: probabilidade e amostragem](https://cursos.alura.com.br/user/matheus-valim1007/course/estatistica-probabilidade-e-amostragem/certificate)
- [Data Science: testando relações com Regressão Linear](https://cursos.alura.com.br/user/matheus-valim1007/course/data-science-testando-relacoes-regressao-linear/certificate)
- [Regressão Linear: técnicas avançadas de modelagem](https://cursos.alura.com.br/user/matheus-valim1007/course/data-science-modelo-regressao-linear-assimetria-statsmodel/certificate)
- [Classificação: aprendendo a classificar dados com Machine Learning](https://cursos.alura.com.br/user/matheus-valim1007/course/classificacao-aprendendo-classificar-dados-machine-learning/certificate)
